...
locale_keys! {
    ...
    CodexOverlaySettings,
    CodexOverlayStartupBehavior,
    CodexOverlayStartupRemember,
    CodexOverlayStartupAlwaysShow,
    CodexOverlayStartupAlwaysHide,
    CodexOverlayResetPosition,
    CodexOverlayResetPositionHelper,
    ChatGptDesktopLifecycle,
    ChatGptMonitorDesktop,
    ChatGptMonitorDesktopHelper,
    ChatGptShowOverlayOnStart,
    ChatGptHideOverlayOnExit,
    ChatGptLifecycleInactive,
    ChatGptLifecycleRunning,
    ChatGptLifecycleNotRunning,
    ChatGptLifecycleDetecting,
    ChatGptLifecycleUnsupported,
    ChatGptLifecycleUnavailable,
    CodexNetworkSettings,
    CodexUseEnvironmentProxy,
    CodexUseEnvironmentProxyHelper,
    CodexManualProxy,
    CodexManualProxyHelper,
    CodexProxyCurrentRoute,
    CodexProxyRouteManual,
    CodexProxyRouteEnvironment,
    CodexProxyRouteDirect,
    CodexProxyRouteInvalid,
    CodexProxyTest,
    CodexProxyTesting,
    CodexProxyClear,
    CodexProxyTestSuccess,
    CodexProxyErrorDnsOrNetwork,
    CodexProxyErrorProxyConnection,
    CodexProxyErrorConfiguration,
    CodexProxyErrorNotLoggedIn,
    CodexProxyErrorAppServerUnavailable,
    CodexProxyErrorService,
    CodexProxyErrorInvalidData,
    ...
    TrayShowWindow,
    TrayShowFloatBar,
    TrayShowCodexOverlay,
    TrayHideCodexOverlay,
    TrayRefreshAll,
    TrayProviders,
    TraySettings,
    TrayCheckForUpdates,
    ...
    // Tauri desktop shell - Codex usage overlay
    CodexOverlayTitle,
    CodexOverlayCachedData,
    CodexOverlayShowingLastSuccess,
    CodexOverlayNoQuotaData,
    CodexOverlayCliNotInstalled,
    CodexOverlayOffline,
    CodexOverlayInvalidData,
    CodexOverlayOneHourQuota,
    CodexOverlayFiveHourQuota,
    CodexOverlayTwentyFourHourQuota,
    CodexOverlaySevenDayQuota,
    CodexOverlayHourQuotaUnit,
    CodexOverlayDayQuotaUnit,
    CodexOverlayGenericQuota,
    CodexOverlayResetAt,
    CodexOverlayResetCredits,
    CodexOverlayAdditionalPrefix,
    CodexOverlayAdditionalSuffix,
